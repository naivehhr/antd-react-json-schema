		...
		return (
			...
			>
				<div style={{ paddingTop: '13px',position:"relative" }} >
					<img style={{ width: 115, height:84,cursor: 'pointer'}} src={value} className="list-img-display"/>
					<div className="list-img-display-mask"  onClick={this.showModal.bind(this, value)}>点击查看</div>
				</div>
				<Modal
