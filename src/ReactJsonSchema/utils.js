...
import "setimmediate";
import * as CustomerLayout from './components/customerlayout'
const widgetMap = {
  boolean: {
    ...
    agreementCheckboxWidget: "AgreementCheckboxWidget",
  },
  string: {
    text: "TextWidget",
    ...
    antdTextArea: "AntdTextAreaWidget",
    ...
    antdImagepickerWidget: "AntdImagepickerWidget",
    antdPhotoPicker: 'AntdPhotoPicker',
    asyncTextWidget: 'AsyncTextWidget',
    antdImageWidget: 'AntdImageWidget',
    antdVcodeWidget: 'AntdVcodeWidget',
    antdDynamicSelectWidget: 'AntdDynamicSelectWidget'
  },
  number: {
    text: "TextWidget",
    select: "SelectWidget",
...
export const renderByCustomerLaout = (customerLayout) => {
  return CustomerLayout[customerLayout] || CustomerLayout.DisplayTableLayout
