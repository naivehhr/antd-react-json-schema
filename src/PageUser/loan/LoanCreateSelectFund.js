 ...
 * @Last Modified time: 2017-09-08 14:53:53
 */
...
import { addLoanRequest } from 'Ajax'
import Container from 'PageUser/Container'
const Step = Steps.Step;
class LoanCreateSelectFund extends Component {
	constructor() {
		super()
		this.state = {
			fundJsonSchema: null,
	...
	submit = async () => {
		...
		let result = await addLoanRequest({
...
export default LoanCreateSelectFund